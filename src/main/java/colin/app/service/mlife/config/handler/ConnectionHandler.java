...
public class ConnectionHandler implements IoHandler {
    ...
    public void sessionOpened(IoSession session) throws Exception {
        //创建数据解析器
        session.setAttribute("DATAPARSER", null);
        //创建连接管理器
    ...
    private NIOConnection createNIOConnection(IoSession session) {
        ...
        nioConnection.setSession(session);
    ...
    public StanzaHandler createStanzaHandler(NIOConnection connection) {
        StanzaHandler stanzaHandler = new ClientStanzaHandler();
        stanzaHandler.createStanzaHandler(connection);
