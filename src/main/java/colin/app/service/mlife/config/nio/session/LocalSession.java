package colin.app.service.mlife.config.nio.session;

import colin.app.service.mlife.config.manager.SessionManager;
import colin.app.service.mlife.config.nio.connection.Connection;
import colin.app.service.mlife.config.nio.fragment.StreamID;
...
public abstract class LocalSession implements Session{
     ...
     */
    public void setAddress(UserPB address){
